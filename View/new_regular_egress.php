        ...
        <div id="main">	
            <div class="wrapper clearfix">
                <div id="slider-holder" class="clearfix">
                    ...
                    <form id="contactForm" action="../Controller/new_regular_egress_recorder.php" method="post" style="    margin-top: -330px; margin-left: 120px;">
                        <fieldset>
                            <div>
                                <br />
                            ...
                            <div>
                                <br />
                                <label>Amount</label>
                                <input name="regular_egress_amount"  id="name" type="text" class="form-poshytip" style="width: 150px; height: 25px;" required="required"/>
                            </div>
                            <div>
                                <label>Day to pay</label>
                                <input name="day_to_pay"  id="name" type="number" min="1" max="28" class="form-poshytip" style="width: 150px; height: 25px;" required="required"/>
                            </div>
                            <div>
                                <br />
                                <label>Date</label>
