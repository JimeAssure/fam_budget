        ...
        <div id="main">	
            <div class="wrapper clearfix">
                <div id="slider-holder" class="clearfix">
                    ...
                    <form id="contactForm" action="../Controller/new_ingress_recorder.php" method="post" style="    margin-top: -330px; margin-left: 120px;">
                        <fieldset>
                            <div>
                                <br />
                                <label>Amount</label>
                                <input name="ingress_amount"  id="name" type="text" class="form-poshytip" style="width: 150px; height: 15px;" required="required"/>
                            </div>
                            <div>
                                <label>Date</label>
                                <input name="ingress_date"  id="password" type="date" class="form-poshytip" style="width: 150px; height: 15px;" required="required"/>
                            </div>
